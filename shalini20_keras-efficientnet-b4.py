...
def create_model():
    ...
    base_model =  efn.EfficientNetB4(weights = 'imagenet', include_top = False, pooling = 'avg', input_shape = SHAPE)
...
for epoch in range(0, 3):
    ...
    if epoch != 0:
        ...
        model.load_weights('efficientnetb4_model.h5')    
    ...
    model.fit_generator(generator = data_generator_train,
                        ...
                        callbacks = [ModelCheckpointFull('efficientnetb4_model.h5')],
...
test_df.to_csv('_efficientnetb4_submission.csv', index = False)
