...
def subsample(df_orig, percentage=.30):
    df_sample = df_orig.sample(frac=percentage)
    
    print(df_orig.shape, df_sample.shape)
    return df_sample

print(train_df.shape, subsample(train_df, .2).shape)




new_df = subsample(train_df, .2)
