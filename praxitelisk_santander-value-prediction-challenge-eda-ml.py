...
print(train_df[train_df.columns[~train_df.columns.isin(constant_df.col_name.tolist())]].shape)
train_df_without_uniques = train_df[train_df.columns[~train_df.columns.isin(constant_df.col_name.tolist())]]
