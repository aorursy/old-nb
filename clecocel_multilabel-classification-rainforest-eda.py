...
all_test_tags[0:20]
test_imgs = [plt.imread('../input/test-jpg-v2/{}.jpg'.format(name)) for name in sample.head(20)['image_name'].values]
...
image_paths = sorted(glob('../input/train-tif-v2/*.tif'))[0:1000]
